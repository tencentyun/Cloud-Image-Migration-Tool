...
class MD5CloudImageV2Uploader(BaseUploader):
    ...
    def __init__(self, config):
        ...
        """
        super(MD5CloudImageV2Uploader, self).__init__(config)
    ...
    def check_config(config):
        ...
        for section, option in MD5CloudImageV2Uploader.mandatory_options:
    ...
    def upload(self, job):
        ...
        new_fileid = hashlib.md5(source).hexdigest()
        status = None
        log = None


        try:
            response_obj = self.image_obj.upload_binary(source, self.bucket, new_fileid)
